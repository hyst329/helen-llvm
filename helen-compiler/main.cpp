...
int main(int argc, char** argv)
{
    ...
    desc.add_options()("help,h", "display this help")("version,v", "display version")("input-file", po::value<string>(),
        "input file")("include-path,I", po::value<vector<string> >(), "path to include files");
